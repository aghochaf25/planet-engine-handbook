...
export default function StormEngineTopography() {
  return (
    <div className="space-y-8 font-sans">
      <div className="flex flex-col gap-2">
        <h2 className="text-3xl font-extrabold tracking-tight text-white flex items-center gap-2">
          <FolderGit2 className="h-7 w-7 text-teal-400" />
          Storm Engine Module Topography
        </h2>
        <p className="text-muted-foreground text-sm">
          Attribution equations calculating storm group velocity decay.
        </p>
      </div>

      <VerificationCard
        pageName="Storm Engine Module Module"
        data={{
          status: "unverified",
          coverage: 0,
          filesReviewed: 0,
