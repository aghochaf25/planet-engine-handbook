...
export default function InfrastructureTopography() {
  return (
    <div className="space-y-8 font-sans">
      <div className="flex flex-col gap-2">
        <h2 className="text-3xl font-extrabold tracking-tight text-white flex items-center gap-2">
          <FolderGit2 className="h-7 w-7 text-teal-400" />
          Infrastructure Config Topography
        </h2>
        <p className="text-muted-foreground text-sm">
          Docker compose, containerization, and orchestration setup specifications.
        </p>
      </div>

      <VerificationCard
        pageName="Infrastructure Config Module"
        data={{
          status: "unverified",
          coverage: 0,
          filesReviewed: 0,
