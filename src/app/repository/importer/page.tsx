...
export default function ImporterTopography() {
  return (
    <div className="space-y-8 font-sans">
      <div className="flex flex-col gap-2">
        <h2 className="text-3xl font-extrabold tracking-tight text-white flex items-center gap-2">
          <FolderGit2 className="h-7 w-7 text-teal-400" />
          Importer Pipeline Topography
        </h2>
        <p className="text-muted-foreground text-sm">
          Version 2 dataset ingestion pipeline translating netCDF inputs to SQL.
        </p>
      </div>

      <VerificationCard
        pageName="Importer Pipeline Module"
        data={{
          status: "unverified",
          coverage: 0,
          filesReviewed: 0,
